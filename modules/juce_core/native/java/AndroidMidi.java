...
{
    if (((Activity) activityContext).getSystemService (/*Activity.MIDI_SERVICE*/ "midi") == null)
	return null;
...
public BluetoothManager getAndroidBluetoothManager()
{
    ...
    synchronized (JuceAppActivity.class) // TODO should this be JuceBridge.getActivityContext().class ?
    {
